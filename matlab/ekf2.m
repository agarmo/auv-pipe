...
global Mass D T eta0 P0 h Q R focus bottom zg W Xuu
...
x_post = x_apr + K*(u(1:12) - H*x_apr); %State estimate update %M� ha annen update n�r Pipeline ikke er tilgjengelig
